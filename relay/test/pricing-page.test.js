...
const PRODUCT_PAGES = [
  ...
  { product: 'parasend', file: 'parasend.html', sells: ['firm/firm'], locale: 'en-US' },
];
const productHtml = {};
...
(function oneMonthlyForm() {
  ...
  // /help is Dutch since 23 September 2026; its English copy is /en/help.
  const PAGES = ['en/pricing.html', 'parasend.html', 'en/index.html', 'signup.html', 'en/help/index.html'];
