...
const slh = require("./slhdsa_sha2_256s");

test("SLH-DSA-SHA2-256s keygen + sign + verify (single-sign, slow ~10s)", () => {
...
test("SLH-DSA-SHA2-256s carries performance_hint=slow_signing", () => {
