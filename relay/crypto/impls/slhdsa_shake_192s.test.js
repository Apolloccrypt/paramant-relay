...
const slh = require("./slhdsa_shake_192s");

test("SLH-DSA-SHAKE-192s keygen + sign + verify (single-sign, slow)", () => {
...
test("SLH-DSA-SHAKE-192s carries performance_hint=slow_signing", () => {
