...
const slh = require("./slhdsa_shake_128s");

test("SLH-DSA-SHAKE-128s keygen + sign + verify (single-sign)", () => {
...
test("SLH-DSA-SHAKE-128s carries performance_hint=slow_signing", () => {
