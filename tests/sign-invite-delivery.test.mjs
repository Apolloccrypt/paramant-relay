...
ok('the screen says the sender has to hand that link over', /send each person their own|yours to hand over|send them their own link/i.test(await page.locator('#step-done').innerText()), await page.locator('#ds-party-links-copy').innerText());
