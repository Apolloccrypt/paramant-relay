...
| "Burned on read" as a universal property | index, parasend, press, rules | `tiers.js` gives Pro 10 reads and Enterprise 100 per link, and /pricing says so. True for Community, not universal |
