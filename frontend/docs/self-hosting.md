...
- **Post-quantum (hybrid) TLS** — on OpenSSL 3.5+ the edge negotiates the `X25519MLKEM768` hybrid key exchange automatically, making the handshake itself quantum-resistant. See [`docs/security/pq-tls.md`](https://github.com/Apolloccrypt/paramant-relay/blob/main/docs/security/pq-tls.md) for the full guide and verification steps.
